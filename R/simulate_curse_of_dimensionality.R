...
cols = paste0("rgb(", seq(0, 0, length.out = nrow(ratios)), ", ", 
  seq(191, 199, length.out = nrow(ratios)), ", ",
  seq(255, 140, length.out = nrow(ratios)), ")")

cols.alpha = paste0("rgba(", seq(0, 0, length.out = nrow(ratios)), ", ",
  seq(191, 199, length.out = nrow(ratios)), ", ",
  seq(255, 140, length.out = nrow(ratios)), ", 0.4)")
