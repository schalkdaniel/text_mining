...
1. We choose $a = \exp(1)$, therefore $F = \exp$. 
   ...
   \]
   But: How to handle $X_{ik} = 0$? This comes later.
...
<li>
   ...
   bias term can decomposed into a term $b_i$ from $w_i$ and 
...
It is obvious that it is not effecient to try this for every possible 
combination. To evaluate trained word vectors, Mikolov et al. provide a word
